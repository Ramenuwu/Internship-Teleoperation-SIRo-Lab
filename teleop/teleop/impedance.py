...
class TiagoImpedance(Node):
    ...
    def __init__(self):
        ...
        self.create_subscription(
            WrenchStamped,
            "/ft_sensor_right_controller/wrench",
            self.wrench_cb,
            10
        )
    ...
    def wrench_cb(self, msg: WrenchStamped):
        ...
        R = self.data.oMf[self.model.getFrameId("arm_right_7_link")].rotation
    ...
    def control_timer_callback(self):
        ...
        try:
            ...
            F_tau = (Lambda  @ xdd_des
                     - LLdinv @ (Kd @ v_6 + Kp @ error_6)
                     + (LLdinv - np.eye(6)) @ self.F_ext
                     + self.F_des
                     - Lambda @ Jdot_qdot_6) * self.alpha                     # (6,)
